...
abstract class Livro
{
    ...
    //construct
    public function __construct($id, $g, $tit, $au, $ed, StatusLivro $status = StatusLivro::DISPONIVEL)
    {
        $this->id = $id;
        $this->genero = $g;
        $this->titulo = $tit;
    ...
    public function __toString(): string{
        return "Livro: {$this->titulo} | Autor: {$this->autor} | Tipo: {$this->getTipo()}";
    }
    //->fazer bonitinho com capa //ver se não é melhor fazer em cada um uma capa diferente.
    //metodos
